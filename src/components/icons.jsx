...
function Icons () {
    return (
        <div className="ml-4">
            ...
            <div className="row mt-3 ml-1" style={{flexShrink: 0, paddingRight: "calc(var(--bs-gutter-x)/ 2)"}}>
                <img src={lobby} alt="" className="gambar-facilities"/>
                <img src={parking} alt="" className="gambar-facilities"/>
                <img src={pool} alt="" className="gambar-facilities"/>
                <img src={spa} alt="" className="gambar-facilities"/>
                <img src={toiletries} alt="" className="gambar-facilities"/>
            </div>
        </div>
    )
}
